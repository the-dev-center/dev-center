...
4.  **Craft a Final Commit Message:**
    After saving and closing the first editor, another editor will open. This is where you combine the messages from your squashed commits into a *single, clear, and descriptive message* for the entire feature. This message will be part of the permanent project history.
...
*   **Developer Workflow:** You can make numerous small, messy, or WIP commits on your feature branches as you work.
...
*   **Manual Step:** You *still* need to author the final, meaningful commit message during the merge process. This ensures the public history is clean and clearly describes the entire feature.
