...
Our systems use Corepack to manage package managers. Corepack acts as a wrapper that ensures the version of pnpm used matches what the project expects.
...
* xref:explanation/infrastructure/pnpm-mechanics.adoc[pnpm Disk Space Saving Mechanisms]
