...
This document defines the standard structure for organizing local code repositories within the Dev-Centr ecosystem. This structure ensures a consistent, predictable environment for both developers and automated tools.
...
`Z:\code\github.com\dev-centr\Dev-Centr`
...
Use this pattern for "pure clones"—repositories you do not own, are not a member of, and have not forked locally. These are used for reference or building from source without intent to contribute.
